 ...
 */
package com.rnb.newbase.persistence.generator.customize.xmlmapper.elements;
...
public class CustomizeResultMapElementGenerator extends
        AbstractXmlElementGenerator {

    private boolean isSimple;

    public CustomizeResultMapElementGenerator(boolean isSimple) {
        super();
